...
import heroImage from '../public/static/yooper-shirts/hero.png';

const yooperShirts = [heroImage];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    dimensions: [400, 680],
    yoopershirts: [
      //import screenshots from /static/projects/yooper-shirts

      '/static/projects/yooper-shirts/hero.png',
    ],
    deployment: {
      web: 'https://dadsagree.com/',
    },
